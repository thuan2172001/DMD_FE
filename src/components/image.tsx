...
const ImagePopup = ({ imageUrl, isShowPreview }: { imageUrl: string; isShowPreview?: boolean }) => {
  ...
  return (
    <div className="cursor-pointer">
      ...
      >
        {isShowPreview ? <img src={imageUrl} /> : "View"}
      </div>

      <Modal open={showPopup} onClose={togglePopup} size="small" className="p-[0px]">
        <Modal.Content image>
